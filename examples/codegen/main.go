// Example: codegen
//
// Demonstrates the full drel codegen workflow:
// 1. Define models with drel.Model[K] and unexported fields
// 2. Run `drel generate` to produce scan/snapshot/diff/meta code
// 3. Use the generated DB struct with typed repositories
//
// Usage:
//
//	cd examples/codegen
...
import (
	...
	"github.com/alternayte/drel/examples/codegen/db"
	"github.com/alternayte/drel/examples/codegen/models"
)
